...
createAccount(@Body() account: AccountDTO): AccountEntity {
 ...
 @Put('add/: accountId')
 addAccountBalance(@Param('accountId' , ParseUUIDPipe) accountId: string,
                   @Param('amount') amount: number) :void {
                     this.accountService.addAccountBalance(accountId , amount);
                   }

 // Remover balance de una cuenta
 @Put('remove/:accountId')
 removeAccountBalance(@Param('accounId' , ParseUUIDPipe) accountId: string,
                      @Param('amount') amount: number): void { 
...
// Verificar balance de una cuenta
 ...
 verifyAccountBalance(@Param('accountId'  , ParseUUIDPipe) accountId: string,
 ...
 @Get('state/:accountId')
 getAccountStatus(@Param('accountId', ParseUUIDPipe) accountId : string ,
 ): boolean {
 ...
 @Put('state/:accountId')
 changeAccountState(@Param('AccountId' , ParseUUIDPipe) accountId: string,
...
@Put('type/:accountId')
changeTypeAccount(@Param('accountId') accountId: string ,
